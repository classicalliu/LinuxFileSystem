...
void Shell::help() {
	...
	std::cout << " 8. cd <name>               -->   跳转到目录<name>， ..表示上层目录，/表示根目录，~表示home目录" << std::endl;
	std::cout << " 9. mkdir <name>            -->   在当前目录下创建子目录" << std::endl;
	std::cout << "10. rmdir <name>            -->   删除子目录<name>" << std::endl;
	std::cout << "11. umask <name>            -->   创建文件屏蔽码" << std::endl;
	std::cout << "12. mv <source> <target>    -->   将文件从<source>移动到<target>" << std::endl;
	std::cout << "13. cp <source> <target>    -->   将文件从<source>移动到<target>" << std::endl;
	std::cout << "14. rm <name>               -->   删除文件名为<name>的文件" << std::endl;
	std::cout << "15. ln <source>             -->   将文件从<source>链接到当前文件夹" << std::endl;
	std::cout << "16. cat <name1> <name2>     -->   连接显示文件内容" << std::endl;
	std::cout << "17. passwd                  -->   修改当前用户密码" << std::endl;
	std::cout << "18. vi <filename>           -->   创建名为<filename>的文件，进入vi编辑界面，输入exit退出" << std::endl;
	std::cout << "19. help                    -->   显示帮助文件" << std::endl;
	std::cout << "20. exit                    -->   退出当前系统" << std::endl;
	pause();
	main_window();
}
